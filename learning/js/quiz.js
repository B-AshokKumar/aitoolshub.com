...
/* ======================================
   SYNCHRONIZE COMPLETED COUNT
====================================== */

function syncLearningCompletedCount() {
...
function showResult() {
    ...
    if (passed) {
        ...
        message =
            "🎉 Excellent work! Lesson completed.";
    ...
    if (passed) {
        ...
        */
        ...
        /*
           Keep the shared completion count
           synchronised immediately.
        */

        syncLearningCompletedCount();
